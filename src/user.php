...
/**
 * shop4flexibee - Stránka uživatele.
 *
...
switch ($oPage->getRequestValue('action')) {
    case 'delete':
        ...
        $confirmator->addItem(new \Ease\TWB\LinkButton('?delete=true&'.$user->myKeyColumn.'='.$user->getID(), _('Yes').' '.\Ease\TWB\Part::glyphIcon('remove'), 'danger'));
