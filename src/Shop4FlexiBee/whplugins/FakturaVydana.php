...
namespace Shop4FlexiBee\whplugins;
 ...
 * @author vitex
 */
class FakturaVydana extends \Shop4FlexiBee\WebHookHandler
{
     ...
     * @return \Shop4FlexiBee\OrderPlugin
     */
    public function orderModulesForInvoiceItems()
    {
        ...
        if (count($prodCodes)) {
            ...
            while (false !== ($entry = $d->read())) {
                ...
                $className  = '\\Shop4FlexiBee\\Shop4FlexiBee\\orderplugins\\'.$pluginName;
