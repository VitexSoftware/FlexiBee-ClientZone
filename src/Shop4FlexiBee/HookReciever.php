<?php
/**
 * shop4flexibee - Příjemce WebHooku
 *
    ...
    function processChanges()
    {
        if (count($this->changes)) {
            ...
            foreach ($this->changes as $change) {
                ...
                $handlerClassFile = 'Shop4FlexiBee/whplugins/'.$handlerClassName.'.php';
                if (file_exists($handlerClassFile)) {
                    include_once $handlerClassFile;
                }

                $handlerClass = '\\Shop4FlexiBee\\Shop4FlexiBee\\whplugins\\'.$handlerClassName;
