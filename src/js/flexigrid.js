    ...
    $.addFlex = function (t, p) {
        ...
        var g = {
            ...
            rePosDrag: function () {
                ...
                if (this.bDiv.scrollWidth > this.bDiv.clientWidth) {
                    //console.log($(this.mDiv).offset().left);

                    if ($(this.hDiv).css('position') === 'fixed') {
                        var move = this.bDiv.scrollLeft - $(this.mDiv).offset().left;
                        $('.flexigrid .hDiv').css({"left": -move});
            ...
            dragEnd: function () {
                if (this.colresize) {
                    ...
                    g.persist("width@" + p.colModel[n].name, nw);
                    if ($.cookies) {
            ...
            toggleCol: function (cid, visible) {
                ...
                g.persist("visible@" + p.colModel[cid].name, visible);
                return visible;
            },
            ...
            changeSort: function (th) { //change sortorder
                ...
                g.persist("sortname", p.sortname);
                g.persist("sortorder", p.sortorder);
...
//							width: $('div:first', pth).width() + "px"
        ...
        if (p.usepager) {
            ...
            $(g.bDiv).after(g.pDiv);
            var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input type="text" size="4" value="1" /> ' + p.outof + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div id="reloadGrid" class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
            ...
            if (p.searchitems) {
                ...
                $('select[name=qtype]', g.sDiv).change(function (e) {
                    g.persist("qtype", $('select[name=qtype]', g.sDiv).val());
                });
        ...
        if (p.title) {
            ...
            $(g.mDiv).append('<div class="gtreset" title="Reset Table"><span></span></div>');
            $('div.gtreset', g.mDiv).click(function () {
                grid = p.myclass + '_' + p.dataclass;
                $.post("gridset.php", {
                    grid: grid,
                    column: 'reset',
